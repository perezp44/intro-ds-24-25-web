...
-   Es muy-muy conveniente acudir al curso con tu propio ordenador (y un ratón)
...
mys_pkgs <- c("tidyverse", "curl", "eurostat", "here", "palmerpenguins", "quantmod", "rio", "gt", "DT", "gapminder", "markdown", "pandoc")
...
-   [**Aula Virtual de la asignatura**](https://aulavirtual.uv.es/course/view.php?id=84668){target="_blank"}: como Aula Virtual es el sitio oficial de la asignatura colgaré allí los anuncios de tipo "oficial". También colgaré en Aula Virtual los detalles sobre la evaluación. 

-   [**RStudio Cloud Project**](https://posit.cloud/content/8720658){target="_blank"}: En otros cursos este recurso nos resulto muy útil, pero ahora la versión gratuita tiene límite de tiempo así que creo que no lo usaré, pero por si acaso aquí está.

- [Cuestionario incial](./mas-cosas/cuestionario-inicial.html){target="_blank"}
...
- [Instrucciones](./mas-cosas/instrucciones_examen.html){target="_blank"} y un [ejemplo](./mas-cosas/ex_final_BigData_24-25_sin-soluciones-bones.html){target="_blank"} de cómo ha de quedar más o menos el documento .html con tus respuestas
